...
import com.bicyclemes.common.exception.file.FileNameLengthLimitExceededException;
import com.bicyclemes.common.exception.file.FileSizeLimitExceededException;
import com.bicyclemes.common.exception.file.InvalidExtensionException;
import com.bicyclemes.common.utils.DateUtils;
import com.bicyclemes.common.utils.StringUtils;
import com.bicyclemes.common.utils.uuid.IdUtils;
import com.bicyclemes.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = BicycleMESConfig.getProfile();
    ...
    {
        int dirLastIndex = BicycleMESConfig.getProfile().length() + 1;
